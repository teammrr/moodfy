...
export const stripeWebhook = async (request, response, context) => {
    ...
    try {
        if (event.type === 'checkout.session.completed') {
            ...
            else if (((_f = (_e = line_items === null || line_items === void 0 ? void 0 : line_items.data[0]) === null || _e === void 0 ? void 0 : _e.price) === null || _f === void 0 ? void 0 : _f.id) === process.env.CREDITS_PRICE_ID) {
