...
const TotalPayingUsersCard = ({ dailyStats, isLoading }) => {
    const isDeltaPositive = useMemo(() => {
        return !!(dailyStats === null || dailyStats === void 0 ? void 0 : dailyStats.paidUserDelta) && (dailyStats === null || dailyStats === void 0 ? void 0 : dailyStats.paidUserDelta) > 0;
    }, [dailyStats]);
    return (<div className='rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark'>
      ...
      <div className='mt-4 flex items-end justify-between'>
        <div>
          <h4 className='text-title-md font-bold text-black dark:text-white'>{dailyStats === null || dailyStats === void 0 ? void 0 : dailyStats.paidUserCount}</h4>
        ...
        <span className={cn('flex items-center gap-1 text-sm font-medium', {
          ...
          {isLoading ? '...' : (dailyStats === null || dailyStats === void 0 ? void 0 : dailyStats.paidUserDelta) !== 0 ? dailyStats === null || dailyStats === void 0 ? void 0 : dailyStats.paidUserDelta : '-'}
          {(dailyStats === null || dailyStats === void 0 ? void 0 : dailyStats.paidUserDelta) !== 0 ? isDeltaPositive ? <UpArrow /> : <DownArrow /> : null}
        </span>
      </div>
    </div>);
};
