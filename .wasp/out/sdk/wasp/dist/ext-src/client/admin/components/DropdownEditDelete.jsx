...
const DropdownDefault = () => {
    ...
    return (<div className='relative'>
      ...
      <div ref={dropdown} onFocus={() => setDropdownOpen(true)} onBlur={() => setDropdownOpen(false)} className={cn('absolute right-0 top-full z-40 w-40 space-y-1 rounded-sm border border-stroke bg-white p-1.5 shadow-default dark:border-strokedark dark:bg-boxdark', {
            block: dropdownOpen,
            hidden: !dropdownOpen,
        })}>
...
//# sourceMappingURL=DropdownEditDelete.jsx.map