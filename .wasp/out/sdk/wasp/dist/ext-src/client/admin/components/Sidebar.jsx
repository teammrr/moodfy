...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    useEffect(() => {
        ...
        if (sidebarExpanded) {
            (_a = document.querySelector('body')) === null || _a === void 0 ? void 0 : _a.classList.add('sidebar-expanded');
        }
        else {
            (_b = document.querySelector('body')) === null || _b === void 0 ? void 0 : _b.classList.remove('sidebar-expanded');
        }
    }, [sidebarExpanded]);
        ...
        <nav className='mt-5 py-4 px-4 lg:mt-9 lg:px-6'>
          ...
          <div>
            ...
            <ul className='mb-6 flex flex-col gap-1.5'>
              {/* <!-- Menu Item Dashboard --> */}
              <NavLink to='/admin' isActive={(_match, location) => location.pathname === '/admin'} className={(isActive) => cn('group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 dark:hover:bg-meta-4', {
          ...
          <div>
            ...
            return (<React.Fragment>
                      <NavLink to='#' isActive={(_match, location) => location.pathname.includes('forms')} className={(isActive) => cn('group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 dark:hover:bg-meta-4', {
                    'bg-gray-700 dark:bg-meta-4': isActive,
                })} onClick={(e) => {
                    e.preventDefault();
            ...
            'bg-gray-700 dark:bg-meta-4': isActive,
              ...
              <SidebarLinkGroup activeCondition={pathname === '/ui' || pathname.includes('ui')}>
                {(handleClick, open) => {
            return (<React.Fragment>
                      <NavLink to='#' isActive={(_match, location) => location.pathname.includes('ui')} className={(isActive) => cn('group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 dark:hover:bg-meta-4', {
                    'bg-gray-700 dark:bg-meta-4': isActive,
                })} onClick={(e) => {
                    e.preventDefault();
                    sidebarExpanded ? handleClick() : setSidebarExpanded(true);
