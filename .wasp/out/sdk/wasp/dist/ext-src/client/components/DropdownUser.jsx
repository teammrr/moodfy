...
const DropdownUser = ({ user }) => {
    ...
    return (<div className='relative'>
      <button ref={trigger} onClick={toggleDropdown} className='flex items-center gap-4 duration-300 ease-in-out text-gray-900 hover:text-yellow-500'>
        ...
        <svg className={cn('hidden fill-current dark:fill-white sm:block', {
      ...
      {/* <!-- Dropdown --> */}
      <div ref={dropdown} className={cn('absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:text-white', {
            hidden: !dropdownOpen,
        })}>
...
//# sourceMappingURL=DropdownUser.jsx.map