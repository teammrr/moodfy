    ...
    var napiModule = (function () {
        ...
        function emnapiWrap(env, js_object, native_object, finalize_cb, finalize_hint, result) {
            ...
            try {
                ...
                if (result) {
                    if (!finalize_cb)
                        return envObject.setLastError(1);
                    reference = emnapiCtx.createReference(envObject, handle.id, 0, 1, finalize_cb, native_object, finalize_hint);
                    referenceId = reference.id;
                    var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer);
                    HEAP_DATA_VIEW.setInt32(result, referenceId, true);
                }
                else {
                    reference = emnapiCtx.createReference(envObject, handle.id, 0, 0, finalize_cb, native_object, !finalize_cb ? finalize_cb : finalize_hint);
                }
        ...
        function napi_create_external(env, data, finalize_cb, finalize_hint, result) {
            ...
            try {
                ...
                if (finalize_cb) {
                    emnapiCtx.createReference(envObject, externalHandle.id, 0, 0, finalize_cb, data, finalize_hint);
                }
    ...
    handle(e) {
        ...
        if ((_a = e === null || e === void 0 ? void 0 : e.data) === null || _a === void 0 ? void 0 : _a.__emnapi__) {
            ...
            if (type === 'load') {
                ...
                if (typeof then === 'function') {
                    then.call(source, (source) => { onLoaded.call(this, source); }, (err) => { throw err; });
                }
                else {
